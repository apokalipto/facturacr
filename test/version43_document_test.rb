...
class Version43DocumentTest < Minitest::Test
  ...
  def test_export_invoice_xml_validation
    ...
    items << FE::Document::Item.new(comercial_code: "002", line_number: 2, quantity: 2, unit: "Unid", description: "Impresora de POS", unit_price: 50, total: 100, taxes: taxes, net_total: 113, subtotal: 100, taxable_base: 18)
    ...
    others = [FE::Document::OtherText.new(xml_attributes: {"code"=>"my123456"}, content: "This is the custom value")]
    payment =["01","03"]
    invoice = FE::ExportInvoice.new(  economic_activity: "01", date: Time.now, issuer: issuer, receiver: receiver, number: 1, items: items, condition: "01", summary: summary,other_charges: other_c , security_code: "12345678", document_situation: "1", others: others, payment_type: payment)
  ...
  def test_purchase_invoice_xml_validation
    ...
    others = [FE::Document::OtherText.new(xml_attributes: {"code"=>"my123456"}, content: "This is the custom value")]
    payment =["01","03"]
    invoice = FE::PurchaseInvoice.new(  economic_activity: "01", date: Time.now, issuer: issuer, receiver: receiver, number: 1, items: items, condition: "01", summary: summary,other_charges: other_c , security_code: "12345678", document_situation: "1", others: others, payment_type: payment)
